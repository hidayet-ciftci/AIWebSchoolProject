...
RAG_TOP_K = int(_to_positive_number(os.getenv("RAG_TOP_K"), 6))
RAG_MAX_DISTANCE = _to_positive_number(os.getenv("RAG_MAX_DISTANCE"), 0.65)
...
RAG_CONTEXT_SOURCES = int(_to_positive_number(os.getenv("RAG_CONTEXT_SOURCES"), 4))
RAG_CONTEXT_CHAR_LIMIT = int(_to_positive_number(os.getenv("RAG_CONTEXT_CHAR_LIMIT"), 5000))
...
OLLAMA_EMBED_TIMEOUT_MS = int(_to_positive_number(os.getenv("OLLAMA_EMBED_TIMEOUT_MS"), 90000))
OLLAMA_NUM_PREDICT = int(_to_positive_number(os.getenv("OLLAMA_NUM_PREDICT"), 400))
